...
class time_last_motion(rt.Property) :
    def duration_immobile(self) : return sigmoid(time.time()-self.value) # sigmoid maps to [0,1]

class unresponsive(rt.Property) : pass
